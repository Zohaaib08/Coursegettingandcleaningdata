THis Code Book summaries the data fields from "tidydata.txt" as part of the Final Assignment for the course "Getting and Cleaning Data"



1. Subject 

  Description - Acts as an identifier for each subject 
  Values - [1,30] 

2. Activity

  Description - Defines the type of activity performed 
  Values - "WALKING" 
           "WALKING_UPSTAIRS"
           "WALKING_DOWNSTAIRS"
           "SITTING"
